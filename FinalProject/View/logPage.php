    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table>
            ...
            <table align="center">
                ...
                <tr align="center">
                    <td><br> Name</td>
                    <td align="center"><br><input type="text" name="loginName" placeholder="Name" id = "loginName">
                ...
                <tr align="center">
                    <td> Password</td>
                    <td align="center"> <input type="password" name="loginpass" placeholder="Password">
                    <td>
